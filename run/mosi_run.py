...
def mosirun():
    ...
    parser = argparse.ArgumentParser(description='CMU-MOSI')
    ...
    parser.add_argument('--model_save_path', type=str, default='checkpoints/mosi_best_model.pth',
    ...
    hyp_params.model_save_path = args.model_save_path

    setup_seed(args.seed)
    test_loss = msatrain.initiate(hyp_params, train_loader, valid_loader, test_loader)
